...
let salesData = [];
let isCowboyMode = false;

function toggleTheme() {
    isCowboyMode = !isCowboyMode;
    document.body.dataset.theme = isCowboyMode ? 'cowboy' : '';
    document.getElementById('themeToggle').textContent = isCowboyMode ? '🤠' : '🌴';
    
    // Play a fun sound effect
    const audio = new Audio(isCowboyMode ? 
        ...
        'data:audio/wav;base64,UklGRl9vT19T');
    audio.play();
}
